        ...
        login.setOnClickListener(View.OnClickListener {
            if (DB.isDatabaseEmpty) {
                ...
                DB.insertServiceProvider(
                    ...
                    "MB",
                    "R3G 0W4",
                    "precisiontunewinnipeg@yahoo.com",
                    "204-555-3456",
                    "f"
                )
                DB.insertServiceProvider(
                    ...
                    "SK",
                    "S7N 1B5",
                    "mistertranssaskatoon@hotmail.com",
                    "306-555-7890",
                    "g"
                )
                DB.insertServiceProvider(
                ...
                DB.insertServiceProvider(
                    ...
                    "ON",
                    "S4R 2N3",
                    "greatcanadianoilchange@yahoo.ca",
                    "306-555-1357",
                    "i"
                )
                DB.insertServiceProvider(
                    ...
                    "MB",
                    "R3G 3J6",
                    "meinekewinnipeg@outlook.com",
                    "204-555-8642",
                    "j"
                )

                //Insert Service Detail Data
                DB.insertServiceDetail(
                    "Full Brake Check",
                    "It will include flushing out the old brake fluid and replacing it with new fluid"
                )
                DB.insertServiceDetail(
                    "Tire Rotation",
                    "It will include swapping the position of the tires to ensure even wear and tear"
                )
                DB.insertServiceDetail(
                    "Battery Replacement",
                    "It will include removing the old battery and installing a new one"
                )
                DB.insertServiceDetail(
                    "Air Filter Replacement",
                    "It will include removing the old air filter and installing a new one"
                )
                DB.insertServiceDetail(
                    "Wheel Alignment",
                    "It will include adjusting the angles of the wheels to ensure they are parallel and perpendicular to the ground"
                )
                DB.insertServiceDetail(
                    "Spark Plug Replacement",
                    "It will include removing the old spark plugs and installing new ones"
                )
                DB.insertServiceDetail(
                    "Coolant Flush",
                    "It will include flushing out the old coolant and replacing it with new coolant"
                )
                DB.insertServiceDetail(
                    "Transmission Service",
                    "It will include draining and refilling the transmission fluid and replacing the filter"
                )
                DB.insertServiceDetail(
                    "Fuel Injection Service",
                    "It will include cleaning the fuel injectors to improve fuel efficiency and engine performance"
                )
                ...
                DB.insertAppointment(
                    ...
                    4,
                    "01/13/2023 03:30 PM",
                    "Granville street, Vancouver, BC, V6H 3K4",
                    "01/11/2023",
                    "01/10/2023 11:00 AM",
                    "Granville street, Vancouver, BC, V6H 3K4",
                    "01/06/2023",
                ...
                DB.insertAppointment(
                    ...
                    4,
                    "03/10/2023 02:30 PM",
                    "Hornby street, Vancouver, BC, 3E4 4S3",
                    "03/13/2023",
                    "03/15/2023 11:30 AM",
                    "Hornby street, Vancouver, BC, 3E4 4S3",
                    "03/08/2023",
                ...
                DB.insertAppointment(
                    ...
                    4,
                    "03/15/2023 03:30 PM",
                    "W Pender street, Vancouver, BC, 2H3 3K4",
                    "03/20/2023",
                    "03/22/2023 03:00 PM",
                    "W Pender street, Vancouver, BC, 2H3 3K4",
                    "03/08/2023",
                ...
                DB.insertAppointment(
                    ...
                    4,
                    "03/20/2023 04:30 PM",
                    "152st street, Vancouver, BC, J6H 3K4",
                    "03/25/2023",
                    "03/27/2023 04:00 PM",
                    "152st street, Vancouver, BC, J6H 3K4",
                    "03/08/2023",
                ...
                DB.insertAppointment(
                    ...
                    4,
                    "03/25/2023 05:30 PM",
                    "King George Avenue, Vancouver, BC, K6V 3K4",
                    "03/27/2023",
                    "03/30/2023 05:00 PM",
                    "King George Avenue, Vancouver, BC, K6V 3K4",
                    "03/08/2023",
                ...
                DB.insertAppointment(
                    ...
                    4,
                    "03/30/2023 06:30 PM",
                    "Granville street, Vancouver, BC, S6H 3K6",
                    "04/05/2023",
                    "03/08/2023 06:00 PM",
                    "Granville street, Vancouver, BC, S6H 3K6",
                    "03/08/2023",
                ...
                Toast.makeText(this@home, "Insert Successfully", Toast.LENGTH_LONG).show()
                startActivity(Intent(this@home, LogIn::class.java))
            } else startActivity(Intent(this@home, LogIn::class.java))
        })
